      ...
      <button
        ...
        className={cn(
          ...
          isFileSelected
            ...
            : 'border-gray-300 hover:border-blue-400 dark:border-gray-500 dark:hover:border-[#ededed]'
        )}
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 p-4 border-b border-gray-200 dark:border-gray-700">
            ...
            {isSearching && (
              <div className="flex-shrink-0">
                <div className="animate-spin rounded-full h-4 w-4 border-2 border-blue-500 dark:border-[#ededed] border-t-transparent"></div>
              </div>
            )}
          </div>
