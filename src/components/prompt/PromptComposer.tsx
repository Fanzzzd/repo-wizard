...
export function PromptComposer() {
  ...
  const renderReviewButton = () => {
    if (hasUnprocessedResponse) {
      return <Button onClick={startReview} size="sm" variant="ghost" className="bg-green-100 text-green-800 hover:bg-green-200" title="Start review" leftIcon={<FileSearch2 size={14} />}>Review</Button>;
    }
    if (canReenterReview) {
